...
- SVN stdout and stderr are drained concurrently under a 45-second command deadline. Limits are enforced while streaming; a timeout, read failure, or output overflow terminates the child immediately rather than buffering a larger result first.
